...
{
// clang-format off
constexpr char licenseKey[] = "";
// clang-format on
...
AppController::createObservers()
{
    ...
    if (mTarget == IMAGE_TARGET_ID)
    {
        ...
        imageTargetConfig.databasePath = "Test.xml";
        imageTargetConfig.targetName = "drive";
